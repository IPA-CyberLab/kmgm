...
func (c *certificateServiceClient) SetupCA(ctx context.Context, in *SetupCARequest, opts ...grpc.CallOption) (*SetupCAResponse, error) {
	out := new(SetupCAResponse)
	err := c.cc.Invoke(ctx, CertificateService_SetupCA_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *certificateServiceClient) IssuePreflight(ctx context.Context, in *IssuePreflightRequest, opts ...grpc.CallOption) (*IssuePreflightResponse, error) {
	...
	err := c.cc.Invoke(ctx, CertificateService_IssuePreflight_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *certificateServiceClient) IssueCertificate(ctx context.Context, in *IssueCertificateRequest, opts ...grpc.CallOption) (*IssueCertificateResponse, error) {
	...
	err := c.cc.Invoke(ctx, CertificateService_IssueCertificate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *certificateServiceClient) GetCertificate(ctx context.Context, in *GetCertificateRequest, opts ...grpc.CallOption) (*GetCertificateResponse, error) {
	...
	err := c.cc.Invoke(ctx, CertificateService_GetCertificate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCertificateServiceServer) SetupCA(context.Context, *SetupCARequest) (*SetupCAResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetupCA not implemented")
}
...
func _CertificateService_SetupCA_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetupCARequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CertificateServiceServer).SetupCA(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CertificateService_SetupCA_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CertificateServiceServer).SetupCA(ctx, req.(*SetupCARequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CertificateService_IssuePreflight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CertificateService_IssuePreflight_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
